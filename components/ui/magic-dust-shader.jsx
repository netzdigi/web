...
// Ported from the 21st.dev "Magic Dust" component (original in TypeScript);
// types were stripped to match this JS codebase, logic is unchanged.
...
export function MagicDustCore({
  ...
  useFrame((state, delta) => {
    ...
    if (pointsGroupRef.current) {
      // Scale down so the widest text always fits the viewport in 3D units.
